...
td=td+"<option>"+rs.getString(1)+"</option>";
 ...
 td=td+"</select></div></tr><tr><td><div align='center'>Session: <select name='session'><option>2004</option><option>2005</option><option>2006</option><option>2007</option><option>2008</option><option>2009</option></select>Year: <select name='year'><option>I</option><option>II</option><option>III</option><option>IV</option><option>V</option></select></div></td></tr><tr><td><div align='center'><input style='FONT-WEIGHT: bold' type='submit' value= 'NEXT'  ></div></td></tr></form></TABLE>";
out.println(td);
}
